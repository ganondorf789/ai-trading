...
@traders_core_bp.route('/api/traders/<address>/star', methods=['POST'])
@login_required
...
@traders_core_bp.route('/api/traders/<address>/ai-analysis', methods=['POST'])
@login_required
...
@traders_core_bp.route('/api/traders/<address>/ai-analysis', methods=['GET'])
@login_required
...
@traders_core_bp.route('/api/traders/<address>/history', methods=['GET'])
@login_required
...
@traders_core_bp.route('/api/traders/rating/<rating>', methods=['GET'])
@login_required
...
@traders_core_bp.route('/api/traders/<address>/position-analysis', methods=['GET'])
@login_required
