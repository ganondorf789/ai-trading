...
@traders_bp.route('/api/traders/best-s', methods=['GET'])
...
@traders_bp.route('/api/traders/best-s/presets', methods=['GET'])
...
@traders_bp.route('/api/traders/<address>/position-analysis', methods=['GET'])
