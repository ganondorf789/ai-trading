...
@app.route('/api/group-comparison/sessions', methods=['GET'])
...
@app.route('/api/group-comparison/sessions/<int:session_id>', methods=['GET'])
...
@app.route('/api/group-comparison/sessions/<int:session_id>/finalists', methods=['GET'])
...
@app.route('/api/group-comparison/sessions/<int:session_id>/groups', methods=['GET'])
...
@app.route('/api/group-comparison/stats', methods=['GET'])
